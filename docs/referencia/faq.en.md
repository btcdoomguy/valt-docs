...
1. Visit [Releases on GitHub](https://github.com/vmabellini/valt/releases)
...
Valt is open-source. You can audit the code on [GitHub](https://github.com/vmabellini/valt).
...
Open an issue on [GitHub](https://github.com/vmabellini/valt/issues) describing:
...
Open an issue on [GitHub](https://github.com/vmabellini/valt/issues) with the "enhancement" tag describing your suggestion.

### Can I contribute to the code?

Yes! Valt is open-source. See the repository on [GitHub](https://github.com/vmabellini/valt) for more information on how to contribute.
